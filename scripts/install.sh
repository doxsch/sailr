...
repo_url="https://github.com/doxsch/sailr"
release_tag=master
script_file="https://raw.githubusercontent.com/doxsch/sailr/$release_tag/sailr.sh"
...
function init {
    ...
    echo "For usage see https://github.com/doxsch/sailr#usage"
}
